<template>
  <v-layout>
    <v-flex text-xs-center xs1 class="cell font-weight-bold">Voucher No</v-flex>
    ...
    <v-flex text-xs-center xs1 class="cell font-weight-bold">Delivery Amount</v-flex>
    <!-- <v-flex text-xs-center xs1 class="cell font-weight-bold">Call Status</v-flex>
    <v-flex text-xs-center xs1 class="cell font-weight-bold">Storing Status</v-flex>-->
    <v-flex text-xs-center xs1 class="cell font-weight-bold">Delivery Status</v-flex>
    <v-flex text-xs-center xs1 class="cell font-weight-bold">Actions</v-flex>
  </v-layout>
</template>
