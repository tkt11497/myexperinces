          ...
          <tbody>
            ...
            <tr v-for="(voucher, index) in items" :key="index">
              ...
              <td>
                ...
                >ReturnSheet ID--{{voucher.assign_sheet.return_sheet_invoice}} ({{voucher.assign_sheet.is_returned?"Return Received":"Yet to Receive"}})</p>
              </td>
              <td>
                <p
...
export default {
  ...
  async asyncData(context) {
    ...
    console.log(data);
    let vouchers = data;
    context.store.commit("title/setTitle", "Delivering Parcels");
